...
# https://ruslanmv.com/blog/How-to-Build-a-basic-LLM-GPT-from-Scratch-in-Python
...
def generate_text(model, prompt, vocab, max_len=50):
    ...
    for _ in range(2):
        ...
        with torch.no_grad():
            ...
            print("after appended preicted_token:")
            print(inputs)
...
#torch.save(model.state_dict(), 'mymodel/rgAI.pt')
#import torchvision.models as models
#model = models.vgg16(pretrained=True)
#torch.save(model.state_dict(), 'mymodel/rgAI.pt')
#model.load_state_dict(torch.load('mymodel/rgAI.pt'))
